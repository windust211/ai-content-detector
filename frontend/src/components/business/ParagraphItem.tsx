...
import { CheckCircleIcon, WarningIcon, CloseCircleIcon } from '../ui/icons';
...
function ParagraphItem({ item, index }: ParagraphItemProps) {
  ...
  return (
    <div className="flex-col items-start" style={{ padding: '12px 0', width: '100%' }}>
      ...
      {showText && (
        <div className="w-full p-3 bg-gray-50 dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700">
          <HighlightedText
            text={item.text}
